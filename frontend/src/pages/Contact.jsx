      ...
      <div className=" w-full grid justify-center grid-cols-1 lg:grid-cols-2 max-sm:text-[15px] gap-10 items-center">
        <div className="flex max-xl:flex-col">
            ...
            <div className="flex text-[20px] items-center font-bold gap-[10px]">
                ...
                <h1><a href="https://t.me/metaitschool_admin" target="_blank" className='max-sm:text-[15px]  link-hover' rel="noopener noreferrer">telegram:@metaitschool_admin</a></h1>
              </div> 
            </div>
            ...
            <div className="flex text-[20px] items-center font-bold gap-[10px]">
                ...
                <h1><a href="https://www.instagram.com/metaitschool?igsh=MXdwdGxtcGMyZTkwMw==" target="_blank" className='link-hover max-sm:text-[15px] ' rel="noopener noreferrer">Meta IT School</a></h1>
              </div> 
            </div>
